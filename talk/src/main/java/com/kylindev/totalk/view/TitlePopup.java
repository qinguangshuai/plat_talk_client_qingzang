...
public class TitlePopup extends PopupWindow {
    ...
    public TitlePopup(Context context, int width, int height){
        ...
        //获得屏幕的宽度和高度
        mScreenWidth = AppCommonUtil.getScreenWidth(mContext);
        mScreenHeight = AppCommonUtil.getScreenHeight(mContext);
    ...
    public void show(View view){
        ...
        //显示弹窗的位置
        showAtLocation(view, popupGravity, mLocation[0] - (view.getWidth()*2), mRect.bottom);
    }
    ...
    private void populateActions(){
        ...
        mListView.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                //设置在文字的左边放一个图标
//                item.mDrawable.setBounds(0, 0, 60, 60);
