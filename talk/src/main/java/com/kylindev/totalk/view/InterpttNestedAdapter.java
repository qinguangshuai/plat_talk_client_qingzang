...
public abstract class InterpttNestedAdapter extends BaseAdapter implements ListAdapter {
	...
	private void buildFlatMetadata() {
		...
		Log.d(AppConstants.LOG_TAG, "OPT: built flat metadata, took "+(System.currentTimeMillis()-startTime)+"ms");
	}
	...
	protected final void buildVisibleMetadata() {
		...
		Log.d(AppConstants.LOG_TAG, "OPT: built visible metadata, took "+(System.currentTimeMillis()-startTime)+"ms");
	}
	...
	public void notifyDataSetChanged() {
		...
		Log.d(AppConstants.LOG_TAG, "OPT: reloaded data set, took "+(System.currentTimeMillis()-startTime)+"ms");
	}
