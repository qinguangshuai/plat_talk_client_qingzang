...
public class FifteenParkCar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        FifteenParkDataDao fifteenParkDataDao = new FifteenParkDataDao(getContext());
        List<DataUser> dataUsers = fifteenParkDataDao.find();
        ...
        if (size > 1 && size % 2 != 0) {
            for (int i = 1; i < size; i += 2) {
                ...
                //(500 + (mGpsPistanceCar - 43) * 5.26f)
                if (aDoubleRatioOfGpsPointCar < 42 && aDoubleRatioOfGpsPointCar1 < 42) {
                    canvas.drawLine((500 + (43 - 43) * 5.26f), 550, (500 + (43 - 43) * 5.26f), 550, mPaint);
                } else if (aDoubleRatioOfGpsPointCar > 42 && aDoubleRatioOfGpsPointCar1 < 42) {
                    canvas.drawLine((500 + (aDoubleRatioOfGpsPointCar - 43) * 5.26f), 550, (500 + (43 - 43) * 5.26f), 550, mPaint);
                } else if (aDoubleRatioOfGpsPointCar < 42 && aDoubleRatioOfGpsPointCar1 > 42) {
                    canvas.drawLine((500 + (43 - 43) * 5.26f), 550, (500 + (aDoubleRatioOfGpsPointCar1 - 43) * 5.26f), 550, mPaint);
                } else {
                    canvas.drawLine((500 + (aDoubleRatioOfGpsPointCar - 43) * 5.26f), 550, (500 + (aDoubleRatioOfGpsPointCar1 - 43) * 5.26f), 550, mPaint);
                }
            }
        }
    }
